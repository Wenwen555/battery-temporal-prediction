...
class Load_Dataset(Dataset):
    ...
    def __init__(self, dataset, config, training_mode, dataset_name):
        ...
        self.x_data = records[0]
        self.y_data = labels[0]
        ...
        for idx in range(len(self.x_data)):
            if isinstance(self.x_data[idx], np.ndarray):
                ...
                self.y_data[idx] = torch.tensor(self.y_data[idx], dtype=torch.float32)
        ...
        #         temp_labels = self.y_data[idx][0][start:start+window_size]
